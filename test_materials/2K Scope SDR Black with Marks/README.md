...
Image Track File that contains 1 minute of 2K scope frames, each filled with pixels with code value (X'=0, Y'=0, Z'=0), with the exception of registration marks at each corner of the frame that use pixels with code value (X'=122, Y'=128, Z'=125).
