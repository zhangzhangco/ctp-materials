...
图像轨迹文件，包含1分钟的 4K full 帧。每帧包含一个中心矩形区域，尺寸为 (2880×2160) 填充代码值 (X″=0, Y″=0, Z″=0)。帧的其余部分填充代码值 (X″= 2234, Y″=1925, Z″=68)。配准标记代码值为 (X″=157, Y″=161, Z″=167) 位于中心矩形区域的四个角落。
...
文件路径: `4k_full_hdr_black_active.zip`
