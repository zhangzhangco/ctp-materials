...
## 2. 用途 (Purpose)
验证显示设备的像素计数和结构(4K, South orientation)。
...
文件路径: `Pixel_Structure_Pattern_S_4k.tiff`

## 6. 像素结构分析 (Pixel Structure Analysis)
根据DCI 1.4.3规范及图像分析生成的16x16像素结构图（South orientation）。
...
| **1** | BLK | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 |
| **2** | BLK | BLK | 2 | 3 | 4 | 5 | 6 | 7 | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 |
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... |
| **7** | BLK | WHT | WHT | BLK | BLK | BLK | BLK | WHT | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 |
| **8** | BLK | BLK | BLK | BLK | BLK | BLK | BLK | BLK | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 |
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... |
| **13** | BLK | BLK | BLK | ? | WHT | ? | WHT | ? | 0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 |

### 结构图 (Structure Diagram)
![Pixel Structure Diagram 4K](pixel_structure_diagram_4k.png)
