...
## 2. 用途 (Purpose)
验证显示设备的像素计数和结构(2K, W orientation)。
...
文件路径: `Pixel_Structure_Pattern_W_2k.tiff`

## 6. 像素结构分析 (Pixel Structure Analysis)
根据DCI 1.4.3规范生成的8x8像素结构图(W orientation)。

### 结构图 (Structure Diagram)
![Pixel Structure Diagram](pixel_structure_diagram_w_2k.png)
