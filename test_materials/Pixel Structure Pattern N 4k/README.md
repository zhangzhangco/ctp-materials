...
North-oriented pixel structure test pattern featuring 16x16 pixel patterns with binary position indicators. See Section 7.5.3 for description.
...
由于文件较大，提供了压缩版本：`Pixel_Structure_Pattern_N_4k.zip`

## 6. 像素结构分析 (Pixel Structure Analysis)
根据 DCI 1.4.3 规范生成的 16×16 像素结构图（N orientation）。

### 结构图 (Structure Diagram)
![Pixel Structure Diagram](pixel_structure_diagram_n_4k.png)
