...
包含1分钟4K Full帧的图像轨迹文件。 每一帧包含一个尺寸为(2880x2160)的中心矩形区域，填充码值(X'=0, Y'=0, Z'=0)。 帧的其余部分填充码值(X'=2901, Y'=2171, Z'=100)。 中心矩形区域的四个角上有码值为(X'=122, Y'=128, Z'=125)的对准标记。
...
文件路径: `4K_Full_SDR_Black_with_Active_Area.tiff`